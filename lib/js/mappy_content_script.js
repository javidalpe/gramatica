...
var showResult = function showResult(value) {
    var reference = document.activeElement;
    ...
    var anotherPopper = new Popper(reference, div, {
        placement: 'top'
    });
    ...
    _reactDom2.default.render(value, div);
};

var callApi = function callApi(text) {
...
/***/ })
/******/ ]);
//# sourceMappingURL=mappy_content_script.js.map